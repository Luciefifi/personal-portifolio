  ...
  return (
    <div className="single-blog">
      <div className="top-conta">
        <button className="single-blog-catbutton">Technology</button>
        <div className="single-title">
          <p>The Impact of technology at the work place:</p>
          <p>Technology advancement</p>
        </div>

        <div className="sing-author">
          <div className="sing-auth-image">
            <img src="/assets/31.jpg" alt="author" />
          </div>
          <div className="sauth-name">
      ...
      <div className="sblog-content">
        ...
        <img src="/assets/pexels-jess-bailey-designs-788946.jpg" alt="image" /> 
          <div className="content">
            ...
            <h3>Reserach your destination</h3>
            <p>
        ...
        <div className="srelated-blog">
        <p>RELATED POSTS</p>
          <div className="related">
          
            <div className="srel">
              <div className="rel-im">
              <img src="/assets/pexels-jess-bailey-designs-788946.jpg" alt="image" /> 
              ...
              <div className="cat-tit">
                ...
                <p>the impact of technolgy in daily life</p>
              </div>
            </div>
            <div className="srel">
